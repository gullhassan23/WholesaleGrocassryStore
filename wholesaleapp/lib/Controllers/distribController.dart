...
class UserController extends GetxController {
  ...
  String? token;
  Distributor? _distributorModel;

  var isLoading = false.obs;
  Distributor? get distributorModel => _distributorModel;
  ...
  Future<void> fetchDistributorData() async {
    try {
      ...
      if (currentUser == null) {
        print("No distributor is currently signed in.");
        return;
      }
      ...
      if (userSnap.exists) {
        distributer.value =
            Distributor.fromMap(userSnap.data() as Map<String, dynamic>);
        print("Distributor data found: ${distributer.value.name}");
      } else {
        print("No Distributor data found for UID: $uid");
      }
    } catch (e) {
  ...
  Future<void> fetchUserProfile() async {
    try {
      ...
      if (userSnap.exists) {
        distributer.value =
            Distributor.fromMap(userSnap.data() as Map<String, dynamic>);
        print("Distributor profile data found: ${distributer.value.name}");
      } else {
        print("No distributor profile data found for UID: $uid");
      }
    } catch (e) {
      Get.snackbar('Error', e.toString());
      print("Error fetching distributor profile: $e");
    }
  }
